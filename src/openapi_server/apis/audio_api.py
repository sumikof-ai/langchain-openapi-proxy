...
from openapi_server.models.create.create_speech_request import CreateSpeechRequest
from openapi_server.models.create.create_transcription200_response import CreateTranscription200Response
from openapi_server.models.create.create_transcription_request_model import CreateTranscriptionRequestModel
from openapi_server.models.create.create_translation200_response import CreateTranslation200Response
...
async def create_transcription(
    ...
    response_format: Optional[AudioResponseFormat] = Form(json, description=""),
