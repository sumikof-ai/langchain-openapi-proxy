...
from openapi_server.models.fine_tuning.fine_tuning_job_hyperparameters_n_epochs import FineTuningJobHyperparametersNEpochs
try:
...
class FineTuningJobHyperparameters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["n_epochs"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "n_epochs": FineTuningJobHyperparametersNEpochs.from_dict(obj.get("n_epochs")) if obj.get("n_epochs") is not None else None
        })
        return _obj
