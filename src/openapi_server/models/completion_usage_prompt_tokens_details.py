...
class CompletionUsagePromptTokensDetails(BaseModel):
    ...
    """ # noqa: E501
    audio_tokens: Optional[StrictInt] = Field(default=None, description="Audio input tokens present in the prompt.")
    cached_tokens: Optional[StrictInt] = Field(default=None, description="Cached tokens present in the prompt.")
