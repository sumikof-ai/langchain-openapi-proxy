...
from openapi_server.models.assistants.assistants_api_tool_choice_option import AssistantsApiToolChoiceOption
from openapi_server.models.create.create_message_request import CreateMessageRequest
from openapi_server.models.create.create_run_request_model import CreateRunRequestModel
...
class CreateRunRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assistant_id", "model", "instructions", "additional_instructions", "additional_messages", "tools", "metadata", "temperature", "top_p", "stream", "max_prompt_tokens", "max_completion_tokens", "truncation_strategy", "tool_choice", "parallel_tool_calls", "response_format"]
