...
from openapi_server.models.create_completion.create_completion_request_model import CreateCompletionRequestModel
from openapi_server.models.create_completion.create_completion_request_prompt import CreateCompletionRequestPrompt
from openapi_server.models.create_completion.create_completion_request_stop import CreateCompletionRequestStop
try:
...
class CreateCompletionRequest(BaseModel):
    ...
    seed: Optional[Annotated[int, Field(le=-9223372036854775616, strict=True, ge=9223372036854775616)]] = Field(default=None, description="If specified, our system will make a best effort to sample deterministically, such that repeated requests with the same `seed` and parameters should return the same result.  Determinism is not guaranteed, and you should refer to the `system_fingerprint` response parameter to monitor changes in the backend. ")
