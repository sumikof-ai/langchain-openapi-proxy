...
class ResponseFormatJsonSchema(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of response format being defined: `json_schema`")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "json_schema": ResponseFormatJsonSchemaJsonSchema.from_dict(obj.get("json_schema")) if obj.get("json_schema") is not None else None
        })
        return _obj
